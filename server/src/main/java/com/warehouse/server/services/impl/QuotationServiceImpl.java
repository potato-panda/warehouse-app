                ...
                quotationHeaderBuilder
                        .addRow(Row.builder()
                                   .add(TextCell.builder()
                                                ...
                                                .fontSize(11)
                                                .text(this.settingService.getSetting(KEY.COMPANY_NAME).getValue())
                                                .build())
                                   .build())
                        .addRow(Row.builder()
                                   .add(TextCell.builder()
                                                .horizontalAlignment(HorizontalAlignment.CENTER)
                                                .textColor(Color.BLUE)
                                                .text("VAT Reg. TIN : " + this.settingService.getSetting(KEY.TIN)
                                                                                             .getValue())
                                                .build())
                                   .build())
                        .addRow(Row.builder()
                                   .add(TextCell.builder()
                                                .horizontalAlignment(HorizontalAlignment.CENTER)
                                                .textColor(Color.BLUE)
                                                .text(this.settingService.getSetting(KEY.ADDRESS).getValue())
                                                .build())
                                   .build())
                        .build();
