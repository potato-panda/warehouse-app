...
ALTER TABLE purchase_orders
    ADD CONSTRAINT uc_purchase_orders_delivery_receipt UNIQUE (delivery_receipt_id);
...
ALTER TABLE purchase_orders
    ADD CONSTRAINT FK_PURCHASE_ORDERS_ON_DELIVERY_RECEIPT FOREIGN KEY (delivery_receipt_id) REFERENCES delivery_receipts (id);
