...
ALTER TABLE addresses
    ADD CONSTRAINT FK_ADDRESSES_ON_SUPPLIER FOREIGN KEY (supplier_id) REFERENCES supplier (id);

ALTER TABLE contacts
    ADD CONSTRAINT FK_CONTACTS_ON_CUSTOMER FOREIGN KEY (customer_id) REFERENCES customers (id);

ALTER TABLE contacts
    ADD CONSTRAINT FK_CONTACTS_ON_SUPPLIER FOREIGN KEY (supplier_id) REFERENCES supplier (id);

ALTER TABLE inventories
    ADD CONSTRAINT FK_INVENTORIES_ON_PRODUCT FOREIGN KEY (product_id) REFERENCES products (id);

ALTER TABLE purchase_orders
    ADD CONSTRAINT FK_PURCHASE_ORDERS_ON_SUPPLIER FOREIGN KEY (supplier_id) REFERENCES supplier (id);
...
ALTER TABLE quote_item
    ADD CONSTRAINT FK_QUOTE_ITEM_ON_PRODUCT FOREIGN KEY (product_id) REFERENCES products (id);
