...
export class InventoryComponent {
  ...
  protected readonly sorter$ = new BehaviorSubject<'address' | 'quantity' | 'product.name' | 'product.sku' | 'product.itemCode' | 'product.description' | 'product.price' | 'product.um' | 'product.umAmount' | null>(null);
  ...
  protected columns = ['address', 'quantity', 'name', 'sku', 'itemCode', 'description', 'price', 'um', 'umAmount', 'actions'];
